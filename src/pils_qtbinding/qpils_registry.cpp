...
void QtObjectClassName::initialize()
{
    ...
    METHOD_(QComboBox, clear)
    METHOD_(QComboBox, count)
    METHOD_(QComboBox, itemText)
    METHOD_(QComboBox, setCurrentText)
    ...
    EXACT_METHOD(QPilsTreeWidget, addTopLevelItem)
    EXACT_METHOD(QPilsTreeWidget, currentItem)
    EXACT_METHOD(QPilsTreeWidget, setCurrentItem)
    EXACT_METHOD(QPilsTreeWidget, clearTree)
    END_CLASS()

    BEGIN_CLASS(QPilsTreeWidgetItem)
    EXACT_METHOD(QPilsTreeWidgetItem, text)
    EXACT_METHOD(QPilsTreeWidgetItem, setText)
    EXACT_METHOD(QPilsTreeWidgetItem, addChild)
    EXACT_METHOD(QPilsTreeWidgetItem, parentNode)
    EXACT_METHOD(QPilsTreeWidgetItem, childCount)
    EXACT_METHOD(QPilsTreeWidgetItem, child)
    EXACT_METHOD(QPilsTreeWidgetItem, expand)
    EXACT_METHOD(QPilsTreeWidgetItem, collapse)
    END_CLASS()

    BEGIN_CLASS(QPilsLocale)
    CONSTRUCTOR_NOARGS(QPilsLocale)
    EXACT_METHOD(QPilsLocale, name)
    EXACT_METHOD(QPilsLocale, bcp47Name)
    EXACT_METHOD(QPilsLocale, language)
    EXACT_METHOD(QPilsLocale, territory)
    END_CLASS()

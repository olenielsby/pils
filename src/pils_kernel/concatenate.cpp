...
namespace PILS
{
	const NodeConstantShort *BuiltinClicheConcatenate::newNode(const Constant *&link, const Integer *value) const
	{
        return new ConcatenateConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheConcatenate::newNode(const Constant *&link, const Float *value) const
	{
        return new ConcatenateConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheConcatenate::newNode(const Constant *&link, const PilsString *value) const
	{
        return new ConcatenateConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheConcatenate::newNode(const Constant *&link, const PilsColor *value) const
	{
        return new ConcatenateConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheConcatenate::newNode(const Constant *&link, const Timestamp *value) const
	{
        return new ConcatenateConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheConcatenate::newNode(const Constant *&link, const Duration *value) const
	{
        return new ConcatenateConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheConcatenate::newNode(const Constant *&link, const PilsDate *value) const
	{
        return new ConcatenateConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheConcatenate::newNode(const Constant *&link, const Cliche *value) const
	{
        return new ConcatenateConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheConcatenate::newNode(const Constant *&link, const NodeConstant *value) const
	{
        return new ConcatenateConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheConcatenate::newNode(const Constant *&link, const Special *value) const
	{
        return new ConcatenateConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheConcatenate::newNode(const Constant *&link, const ListConstant *value) const
	{
        return new ConcatenateConstant(link, *this, value);
	}

...
namespace PILS
{
	...
	const NodeConstantShort *BuiltinClicheOperationPlus::newNode(const Constant *&link, const Float *value) const
	{
        return new const OperationPlusFloat(link, value);
	}

	const NodeConstantShort *BuiltinClicheOperationPlus::newNode(const Constant *&link, const Timestamp *value) const
	{
        return new const OperationPlusTimestamp(link, value);
	}

	const NodeConstantShort *BuiltinClicheOperationPlus::newNode(const Constant *&link, const Duration *value) const
	{
        return new const OperationPlusDuration(link, value);
	}

	const NodeConstantShort *BuiltinClicheOperationPlus::newNode(const Constant *&link, const PilsDate *value) const
	{
	...
	const NodeConstantShort *BuiltinClicheOperationMinus::newNode(const Constant *&link, const Integer *value) const
	{
        return new const OperationMinusInteger(link, value);
	}

	const NodeConstantShort *BuiltinClicheOperationMinus::newNode(const Constant *&link, const Float *value) const
	{
        return new const OperationMinusFloat(link, value);
	}

	const NodeConstantShort *BuiltinClicheOperationMinus::newNode(const Constant *&link, const Timestamp *value) const
	{
        return new const OperationMinusTimestamp(link, value);
	}

	const NodeConstantShort *BuiltinClicheOperationMinus::newNode(const Constant *&link, const Duration *value) const
	{
        return new const OperationMinusDuration(link, value);
	}

	const NodeConstantShort *BuiltinClicheOperationMinus::newNode(const Constant *&link, const PilsDate *value) const
	{
	...
	const NodeConstantShort *BuiltinClicheOperationTimes::newNode(const Constant *&link, const Integer *value) const
	{
        return new const OperationTimesInteger(link, value);
	}

	const NodeConstantShort *BuiltinClicheOperationTimes::newNode(const Constant *&link, const Float *value) const
	{
        return new const OperationTimesFloat(link, value);
	}

	const NodeConstantShort *BuiltinClicheOperationTimes::newNode(const Constant *&link, const Duration *value) const
	{
	...
	const NodeConstantShort *BuiltinClicheOperationDivide::newNode(const Constant *&link, const Integer *value) const
	{
        return new const OperationDivideInteger(link, value);
	}

	const NodeConstantShort *BuiltinClicheOperationDivide::newNode(const Constant *&link, const Float *value) const
	{
        return new const OperationDivideFloat(link, value);
	}

	const NodeConstantShort *BuiltinClicheOperationDivide::newNode(const Constant *&link, const Duration *value) const
	{
	...
	const NodeConstantShort *BuiltinClicheOperationIntegerDivide::newNode(const Constant *&link, const Integer *value) const
	{
        return new const OperationIntegerDivideInteger(link, value);
	}

	const NodeConstantShort *BuiltinClicheOperationIntegerDivide::newNode(const Constant *&link, const Float *value) const
	{
	...
	const NodeConstantShort *BuiltinClicheOperationIntegerDivide::newNode(const Constant *&link, const Duration *value) const
	{
	...
	const NodeConstantShort *BuiltinClicheOperationModulo::newNode(const Constant *&link, const Integer *value) const
	{
        return new const OperationModuloInteger(link, value);
	}

	const NodeConstantShort *BuiltinClicheOperationModulo::newNode(const Constant *&link, const Float *value) const
	{

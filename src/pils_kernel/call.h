...
namespace PILS
{
	...
	{
	public:
		CallingConstant(const Constant *&link, const BuiltinClicheCalling &cliche, const Constant *value)
	...
	{
	public:
		CallingOkConstant(const Constant *&link, const BuiltinClicheCallingOk &cliche, const Constant *value)
	...
	{
	public:
		WhoTagConstant(const Constant *&link, const BuiltinClicheWhoTag &cliche, const Constant *value)
			: NodeConstantTiny(link, cliche, value)
		{}
        const Step *calling(Runner &run, const Constant &call) const override;
        const Step *calling(Runner &run, const Integer &call) const override;
	...
	{
	public:
		WhoTagConstantTrailer(const Constant *&link, const BuiltinClicheWhoTagTrailer &cliche, const Constant *const *value)
	...
	{
	public:
		NotConstant(const Constant *&link, const BuiltinClicheNot &cliche, const Constant *value)
			: NodeConstantTiny(link, cliche, value)
		{}
        const Step *calling(Runner &run, const Constant &call) const override;
        const Step *calling(Runner &run, const Integer &call) const override;

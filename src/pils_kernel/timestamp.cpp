...
namespace PILS
{
	...
	{
		const Constant *&chain = hashChain((size_t)value ^ (size_t)(value >> 32));
	...
	const Timestamp *Constant::hashLookupTimestamp(long long value) const
	{
	...
	const Duration *Constant::hashLookupDuration(long long value) const
	{
	...
	const PilsDate *Constant::hashLookupPilsDate(long long value) const
	{
    ...
    bool Converter::convert(const PlatformSpecializedNodeConstantTiny &)
    {
        return false;
    }

...
namespace PILS
{
	...
	public:
		SinkIndex(const CallWho &what, long index)
			: what(what), index(index), indexInteger(nullptr)
		{}
	...
	{
	public:
		RangeConstant(const Constant *&link, const BuiltinClicheRange &cliche, const Integer *value)

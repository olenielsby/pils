...
namespace PILS
{
	...
	const Step *SinkAssigningWho::pass(Runner &run, PassingMind *mind, const Express *what)
	{
		...
		if (key)
		{
            const Any *old = mind->set(key, assignValue);
	...
	{
        return new const WhoEval(this, who);
	}

	const NodeConstantShort *BuiltinClicheEval::newNode(const Constant *&link, const Integer *value) const
	{
        return new const OperationEvalConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheEval::newNode(const Constant *&link, const Float *value) const
	{
        return new const OperationEvalConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheEval::newNode(const Constant *&link, const PilsColor *value) const
	{
        return new const OperationEvalConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheEval::newNode(const Constant *&link, const Timestamp *value) const
	{
        return new const OperationEvalConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheEval::newNode(const Constant *&link, const Duration *value) const
	{
        return new const OperationEvalConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheEval::newNode(const Constant *&link, const PilsDate *value) const
	{
        return new const OperationEvalConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheEval::newNode(const Constant *&link, const PilsString *value) const
	{
        return new const OperationEvalConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheEval::newNode(const Constant *&link, const Cliche *value) const
	{
        return new const OperationEvalConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheEval::newNode(const Constant *&link, const ListConstant *value) const
	{
        return new const OperationEvalConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheEval::newNode(const Constant *&link, const NodeConstant *value) const
	{
        return new const OperationEvalConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheEval::newNode(const Constant *&link, const Special *value) const
	{
        return new const OperationEvalConstant(link, *this, value);
	}
	...
	{
        return new const OperationEvalExpress(*this, value);
	}

	const CallWho *OperationEvalConstant::callWho(const Any *who) const
	{
        return new const WhoEvalConstant(this, who);
	}

	const CallWho *OperationEvalExpress::callWho(const Any *who) const
	{
        return new const WhoEvalExpress(this, who);
	}
	...
	{
        return new const Quote(*this, element);
	}
	...
	const NodeConstantShort *BuiltinClicheUseline::newNode(const Constant *&link, const Integer *value) const
	{
        return new const UselineConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheUseline::newNode(const Constant *&link, const Float *value) const
	{
        return new const UselineConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheUseline::newNode(const Constant *&link, const PilsColor *value) const
	{
        return new const UselineConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheUseline::newNode(const Constant *&link, const Timestamp *value) const
	{
        return new const UselineConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheUseline::newNode(const Constant *&link, const Duration *value) const
	{
        return new const UselineConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheUseline::newNode(const Constant *&link, const PilsDate *value) const
	{
        return new const UselineConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheUseline::newNode(const Constant *&link, const PilsString *value) const
	{
        return new const UselineConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheUseline::newNode(const Constant *&link, const Cliche *value) const
	{
        return new const UselineConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheUseline::newNode(const Constant *&link, const ListConstant *value) const
	{
        return new const UselineConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheUseline::newNode(const Constant *&link, const NodeConstant *value) const
	{
        return new const UselineConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheUseline::newNode(const Constant *&link, const Special *value) const
	{
        return new const UselineConstant(link, *this, value);
	}
	...
	{
        return new const UselineExpress(*this, value);
	}

	const CallWho *UselineConstant::callWho(const Any *who) const
	{
        return new const WhoUselineConstant(this, who);
	}

	const CallWho *UselineExpress::callWho(const Any *who) const
	{
		if (element[0]->as_Ruleset())
            return new const WhoUselineRuleset(this, who);
        else return new  const WhoUselineExpress(this, who);
	}

	const Any *BuiltinClicheUse::node(const Any *const *element) const
	{
		if (element[1]->as_Ruleset())
            return new const UseRuleset(*this, element);
        else return new const Use(*this, element);
	}

	const Any *BuiltinClicheUsing::node(const Any *const *element) const
	{
        return new const Using(*this, element);
	}

	const Any *BuiltinClicheThrough::node(const Any *const *element) const
	{
        return new const Through(*this, element);
	}

	const Any *BuiltinClicheAround::node(const Any *const *element) const
	{
        return new const Around(*this, element);
	}

    const Any *BuiltinClicheListener::node(const Any *const *element) const
    {
        if (auto channel = element[1]->as_Channel())
        {
            return new const Listener(element[0], channel);
        }
	...
	const Step *SinkUse::pass(Runner &run, const Any *value)
	{
		...
		run.where_->retain();
		new (run.allocate(sizeof(SinkWhereabout))) SinkWhereabout(run.where_);
        run.where_ = new const Using(run.where_, value);
		return &statement;
	}
	...
	{
        const Using *thing = new const Using(value, but);
	...
	{
        const Through *thing = new const Through(value, but);
		return (run.sink = this + 1)->pass(run, thing);
	}
	...
	{
        const Around *thing = new const Around(value, but);
		return (run.sink = this + 1)->pass(run, thing);
	}
	...
	{
        return new const If(*this, element);
	}

	const Any *BuiltinClicheIfElse::node(const Any *const *element) const
	{
        return new const IfElse(*this, element);
	}
		...
		if (!altered)
		{
			...
			else
			{
				...
				for (altered = new const Any*[count]; originalElement < element; altered++)
					(*altered = *originalElement++)->retain();
			}
		}
		*altered++ = value;
		element++;
	...
	const Step *SinkTransformSaveListElement::step_(Runner &run)
	{
		...
		if (altered)
		{
			...
			for (const Any*const * p = altered;; p++)
			{
				...
				if (!(*p)->as_Constant())
				{
                    value = new ((count->value - 1) * sizeof(Any*)) const ListExpress(altered, count->value);
					break;
				}
			}
			delete altered;
	...
	const NodeConstantShort *BuiltinClicheOr::newNode(const Constant *&link, const Integer *value) const
	{
        return new const OrConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheOr::newNode(const Constant *&link, const Float *value) const
	{
        return new const OrConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheOr::newNode(const Constant *&link, const PilsColor *value) const
	{
        return new const OrConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheOr::newNode(const Constant *&link, const Timestamp *value) const
	{
        return new const OrConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheOr::newNode(const Constant *&link, const Duration *value) const
	{
        return new const OrConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheOr::newNode(const Constant *&link, const PilsDate *value) const
	{
        return new const OrConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheOr::newNode(const Constant *&link, const PilsString *value) const
	{
        return new const OrConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheOr::newNode(const Constant *&link, const Cliche *value) const
	{
        return new const OrConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheOr::newNode(const Constant *&link, const Special *value) const
	{
        return new const OrConstant(link, *this, value);
	}

    const NodeConstantShort *BuiltinClicheOr::newNode(const Constant *&link, const ListConstant *value) const
	{
        return new const OrConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheOr::newNode(const Constant *&link, const NodeConstant *value) const
	{
        return new const OrConstant(link, *this, value);
	}
	...
	{
        return new const OrExpress(*this, value);
	}

	const CallWho *OrConstant::callWho(const Any *who) const
	{
        return new const WhoOrConstant(this, who);
	}

	const CallWho *OrExpress::callWho(const Any *who) const
	{
        return new const WhoOrExpress(this, who);
	}

	const NodeConstantShort *BuiltinClicheAnd::newNode(const Constant *&link, const Integer *value) const
	{
        return new const AndConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnd::newNode(const Constant *&link, const Float *value) const
	{
        return new const AndConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnd::newNode(const Constant *&link, const PilsColor *value) const
	{
        return new const AndConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnd::newNode(const Constant *&link, const Timestamp *value) const
	{
        return new const AndConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnd::newNode(const Constant *&link, const Duration *value) const
	{
        return new const AndConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnd::newNode(const Constant *&link, const PilsDate *value) const
	{
        return new const AndConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnd::newNode(const Constant *&link, const PilsString *value) const
	{
        return new const AndConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnd::newNode(const Constant *&link, const Cliche *value) const
	{
        return new const AndConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnd::newNode(const Constant *&link, const Special *value) const
	{
        return new const AndConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnd::newNode(const Constant *&link, const ListConstant *value) const
	{
        return new const AndConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnd::newNode(const Constant *&link, const NodeConstant *value) const
	{
        return new const AndConstant(link, *this, value);
	}
	...
	{
        return new const AndExpress(*this, value);
	}

	const CallWho *AndConstant::callWho(const Any *who) const
	{
        return new const WhoAndConstant(this, who);
	}

	const CallWho *AndExpress::callWho(const Any *who) const
	{
        return new const WhoAndExpress(this, who);
	}

	const NodeConstantShort *BuiltinClicheAnyway::newNode(const Constant *&link, const Integer *value) const
	{
        return new const AnywayConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnyway::newNode(const Constant *&link, const Float *value) const
	{
        return new const AnywayConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnyway::newNode(const Constant *&link, const PilsColor *value) const
	{
        return new const AnywayConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnyway::newNode(const Constant *&link, const Timestamp *value) const
	{
        return new const AnywayConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnyway::newNode(const Constant *&link, const Duration *value) const
	{
        return new const AnywayConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnyway::newNode(const Constant *&link, const PilsDate *value) const
	{
        return new const AnywayConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnyway::newNode(const Constant *&link, const PilsString *value) const
	{
        return new const AnywayConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnyway::newNode(const Constant *&link, const Cliche *value) const
	{
        return new const AnywayConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnyway::newNode(const Constant *&link, const Special *value) const
	{
        return new const AnywayConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnyway::newNode(const Constant *&link, const ListConstant *value) const
	{
        return new const AnywayConstant(link, *this, value);
	}

	const NodeConstantShort *BuiltinClicheAnyway::newNode(const Constant *&link, const NodeConstant *value) const
	{
        return new const AnywayConstant(link, *this, value);
	}
	...
	{
        return new const AnywayExpress(*this, value);
	}

	const CallWho *AnywayConstant::callWho(const Any *who) const
	{
        return new const WhoAnywayConstant(this, who);
	}

	const CallWho *AnywayExpress::callWho(const Any *who) const
	{
        return new const WhoAnywayExpress(this, who);
	}
		...
		else
		{
			...
			public:
				void add(const Any *element)
				{
                    ...
                    constant = constant && element->as_Constant() != nullptr;
				}
				const Any *build()
				{
					const Any *result;
					...
					if (constant)
                        ...
                        result = new ((count - 1) *  sizeof(const Any *)) ListExpress(&vector[0], count);
					vector.clear();
					constant = true;
					return result;
				}
	...
	{
        return new const Comment(*this, element);
	}
	...
	{
        return new const Combined(*this, element);
	}

	const Step *SinkCombine::pass(Runner &run, const Any *value)
	{
		const Any *thing = this->thing;
        return (run.sink = this + 1)->pass(run, new const Combined(BuiltinClicheCombined::singleton, thing, value));
	}
	...
	const ClicheShort *PredefinedNameCall::newCliche(const Constant *&link, const Constant *a) const
	{
        return new const SwitchClicheShort(link, this, a);
	}

	const ClicheLong *PredefinedNameCall::newCliche(const Constant *&link, const Constant *const *a, size_t c) const
	{
		if (a[0] == &Empty::singleton)
            return	new ((c - 1) * sizeof(Constant*)) const SwitchClicheTrailer(link, this, a, c);
        else return	new ((c - 1) * sizeof(Constant*)) const SwitchClicheLong(link, this, a, c);
	}

	const NodeConstantShort *SwitchClicheShort::newNode(const Constant *&link, const Integer *value) const
	{
        return new const SwitchConstantShort(link, *this, value);
	}

	const NodeConstantShort *SwitchClicheShort::newNode(const Constant *&link, const Float *value) const
	{
        return new const SwitchConstantShort(link, *this, value);
	}

	const NodeConstantShort *SwitchClicheShort::newNode(const Constant *&link, const PilsColor *value) const
	{
        return new const SwitchConstantShort(link, *this, value);
	}

	const NodeConstantShort *SwitchClicheShort::newNode(const Constant *&link, const Timestamp *value) const
	{
        return new const SwitchConstantShort(link, *this, value);
	}

	const NodeConstantShort *SwitchClicheShort::newNode(const Constant *&link, const Duration *value) const
	{
        return new const SwitchConstantShort(link, *this, value);
	}

	const NodeConstantShort *SwitchClicheShort::newNode(const Constant *&link, const PilsDate *value) const
	{
        return new const SwitchConstantShort(link, *this, value);
	}

	const NodeConstantShort *SwitchClicheShort::newNode(const Constant *&link, const PilsString *value) const
	{
        return new const SwitchConstantShort(link, *this, value);
	}

	const NodeConstantShort *SwitchClicheShort::newNode(const Constant *&link, const Cliche *value) const
	{
        return new const SwitchConstantShort(link, *this, value);
	}

	const NodeConstantShort *SwitchClicheShort::newNode(const Constant *&link, const ListConstant *value) const
	{
        return new const SwitchConstantShort(link, *this, value);
	}

	const NodeConstantShort *SwitchClicheShort::newNode(const Constant *&link, const NodeConstant *value) const
	{
        return new const SwitchConstantShort(link, *this, value);
	}

	const NodeConstantShort *SwitchClicheShort::newNode(const Constant *&link, const Special *value) const
	{
        return new const SwitchConstantShort(link, *this, value);
	}

	const NodeConstantLong *SwitchClicheLong::newNodeConstant(const Constant *&link, const Constant *const *value) const
	{
        return new ((count - 1) * sizeof(Constant*)) const SwitchConstantLong(link, *this, value);
	}

	const NodeConstantLong *SwitchClicheTrailer::newNodeConstant(const Constant *&link, const Constant *const *value) const
	{
        return new ((count - 1) * sizeof(Constant*)) const SwitchConstantTrailer(link, *this, value);
	}
	...
	const Any *SwitchClicheLong::node(const Any *const *element) const
	{
		for(size_t i = 0; i < count; i++)
		{
            if(element[i]->as_Constant() == nullptr)
                return new ((count - 1) * sizeof(Constant*)) const SwitchExpressLong(*this, element);
		}
	...
	const Any *SwitchClicheTrailer::node(const Any *const *element) const
	{
		...
		{
            if(element[i]->as_Constant() == nullptr)
                return new ((count - 1) * sizeof(Constant*)) const SwitchExpressTrailer(*this, element);
		}
		return ClicheLong::node((const Constant *const *)(void *const *)element);
	}
	...
	{
        return new const WhoSwitchCall(call, who);
	}
	...
	{
        return new const WhoSwitchTry(call, who);
	}
	...
	{
        return new const WhoPropertyDistinct(this, who);
	}
	...
	{
        return new const WhoPropertyCounts(this, who);
	}
	...
	const Step *PipeDistinct::pipeItem(Runner &run, const Any *item)
	{
		...
		{
			item->retain(); // memory might be recycled while piping

...
//		using ClicheTrailer::node;
	public:
		ClicheSplitter(const Constant *&link, const Constant *h, const Constant *const *a, size_t c)
	...
	{
	public:
		Splitter(const Constant *&link, const ClicheSplitter &cliche, const Constant *const *element)
